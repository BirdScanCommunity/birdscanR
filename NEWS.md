...
- New functionality: the function `compileData()` was added to compile a standardized MR1 dataset for publication to a data repository and allow easier interoperability (#44).
