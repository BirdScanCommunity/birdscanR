...
This outlines how to propose a change to birdscanR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("BirdScanCommunity/birdscanR", fork = TRUE)`.
...
Please note that the birdscanR project is released with a [Contributor
Code of
Conduct](https://birdscancommunity.github.io/birdscanR/CODE_OF_CONDUCT.md).
