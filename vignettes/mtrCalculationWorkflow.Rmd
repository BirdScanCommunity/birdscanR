...
# =============================================================================
  ...
  outputFile = file.path(mainOutputDir, 
                         paste0(dbName, "_filtered_", 
                                ...
                                "timeRange", paste(format(timeRangeData, "%Y%m%d"), 
                                                   collapse = "to"), 
                                "_",
                                "echoVal", as.character(useEchoValidator), 
                                ".rds"))
  saveRDS(cData, outputFile)
  ...
  if (saveMTR2File){
    if (computePerDayNight){
      outputFile = paste0("mtr_", dbName, 
                           ...
                           "time", 
                           paste(format(timeRangesTimeBins, "%Y%m%d"), 
                                 collapse = "to"), 
                           "perDayNight_", 
      ...
      outputFile = paste0("mtr_", dbName, 
                    "_alt", paste(altitudeRange.mtr, 
                                  collapse = "to"), 
                    "per", altitudeBinSize, "m_", 
                    "time", paste(format(timeRangesTimeBins, "%Y%m%d"), 
                                  collapse = "to"), 
...
The `birdscanR` package provides some basic plotting functionality to visualize the mtr results. Here's an example to create a longitudinal plot:
...
And here's an example to create an exploration plot
