...
vignette: >
  %\VignetteIndexEntry{How to calculate Activity/Migration Traffic Rates}
...
1.    Filter the data to your target output period, class, etcetera.
...
With the second plotting function `plotExploration()` you can create a time series plot of the detected objects. Each object is shown at the respective height (m agl) and time:
