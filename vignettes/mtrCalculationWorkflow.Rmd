...
The `birdscanR` package provides some basic plotting functionality to visualize the mtr results. 

Here's an example to create a time series plot of the mtr values (one per altitude bin in the mtr data):
