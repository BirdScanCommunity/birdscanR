...
#' @description With the function \code{filterData} both the echo and protocol
#' data can be filtered by several parameters. The function returns the
#' filtered echo and protocol data.
#'
...
#' the function \code{filterProtocolData}. Echoes not detected during the
#' listed protocols will be excluded.
