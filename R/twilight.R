...
twilight <- function(timeRange,
  ...
  # ===========================================================================
  dateSeq <- seq(
    as.Date(timeRange[1], tz = timeZone) - 1,
  ...
  # ===========================================================================
  nauticalDawn <- suntools::crepuscule(
    crds = lon_lat,
    dateTime = dateSeq,
    solarDep = 12,
    direction = "dawn",
  ...
  nauticalDusk <- suntools::crepuscule(
    crds = lon_lat,
    dateTime = dateSeq,
    solarDep = 12,
    direction = "dusk",
