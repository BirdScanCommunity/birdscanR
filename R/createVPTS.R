...
createVPTS = function(dbName,
                      outputDir,
                      echoes,
                      classSelection      = c("passerine_type", "wader_type",
...
# =============================================================================
  if (!"feature37.speed" %in% colnames(echoes)){
    stop(paste0("Couldn't find feature37.speed in the echo table. Are you ",
...
# =============================================================================
  message(paste0("Computing number of animals (n_dbz,), ",
